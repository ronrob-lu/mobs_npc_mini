...
> [!NOTE]
> I still dont know,  what it is for but its funny to play already.
...
## Installation
Since everything runs under the Luanti engine, installation is identical: drop the `mobs_npc_mini` folder into the respective `/mods/` directory of your world or minetest path.
